...
(
  ...
  CONSTRAINT FK_schema_selection_rule_schema FOREIGN KEY (schema_id_number) REFERENCES naaccr.STAGING_SCHEMA(schema_id_number)
);
...
(
  ...
  CONSTRAINT FK_schema_item_schema FOREIGN KEY (schema_id_number) REFERENCES naaccr.STAGING_SCHEMA(schema_id_number),
  CONSTRAINT FK_schema_item_naaccr FOREIGN KEY (item_num) REFERENCES naaccr.NAACCR_ITEM(item_num)
);
...
(
  ...
  CONSTRAINT FK_schema_item_req_item FOREIGN KEY (schema_id_number, item_num) REFERENCES naaccr.SCHEMA_ITEM(schema_id_number, item_num)
);
...
(
  ...
  CONSTRAINT FK_schema_item_code_item FOREIGN KEY (schema_id_number, item_num) REFERENCES naaccr.SCHEMA_ITEM(schema_id_number, item_num)
);

CREATE INDEX idx_selection_schema ON naaccr.SCHEMA_SELECTION_RULE(schema_id_number);
CREATE INDEX idx_item_schema ON naaccr.SCHEMA_ITEM(schema_id_number);
CREATE INDEX idx_req_schema_item ON naaccr.SCHEMA_ITEM_REQUIREMENT(schema_id_number, item_num);
CREATE INDEX idx_code_schema_item ON naaccr.SCHEMA_ITEM_CODE(schema_id_number, item_num);
