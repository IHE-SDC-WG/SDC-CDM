...
CREATE CLUSTERED INDEX idx_observation_period_id_1 ON omop.observation_period (person_id ASC);

CREATE CLUSTERED INDEX idx_visit_person_id_1 ON omop.visit_occurrence (person_id ASC);
...
CREATE CLUSTERED INDEX idx_condition_person_id_1 ON omop.condition_occurrence (person_id ASC);
...
CREATE CLUSTERED INDEX idx_drug_person_id_1 ON omop.drug_exposure (person_id ASC);
...
CREATE CLUSTERED INDEX idx_procedure_person_id_1 ON omop.procedure_occurrence (person_id ASC);
...
CREATE CLUSTERED INDEX idx_measurement_person_id_1 ON omop.measurement (person_id ASC);
...
CREATE CLUSTERED INDEX idx_observation_person_id_1 ON omop.observation (person_id ASC);
...
CREATE CLUSTERED INDEX idx_death_person_id_1 ON omop.death (person_id ASC);
...
CREATE CLUSTERED INDEX idx_note_nlp_note_id_1 ON omop.note_nlp (note_id ASC);
...
CREATE CLUSTERED INDEX idx_care_site_id_1 ON omop.care_site (care_site_id ASC);

CREATE CLUSTERED INDEX idx_provider_id_1 ON omop.provider (provider_id ASC);
...
CREATE CLUSTERED INDEX idx_drug_era_person_id_1 ON omop.drug_era (person_id ASC);
CREATE INDEX idx_drug_era_concept_id_1 ON omop.drug_era (drug_concept_id ASC);

CREATE CLUSTERED INDEX idx_dose_era_person_id_1 ON omop.dose_era (person_id ASC);
CREATE INDEX idx_dose_era_concept_id_1 ON omop.dose_era (drug_concept_id ASC);

CREATE CLUSTERED INDEX idx_condition_era_person_id_1 ON omop.condition_era (person_id ASC);
...
CREATE CLUSTERED INDEX idx_metadata_concept_id_1 ON omop.metadata (metadata_concept_id ASC);
...
CREATE CLUSTERED INDEX idx_concept_concept_id ON omop.concept (concept_id ASC);
...
CREATE CLUSTERED INDEX idx_vocabulary_vocabulary_id ON omop.vocabulary (vocabulary_id ASC);

CREATE CLUSTERED INDEX idx_domain_domain_id ON omop.domain (domain_id ASC);

CREATE CLUSTERED INDEX idx_concept_class_class_id ON omop.concept_class (concept_class_id ASC);

CREATE CLUSTERED INDEX idx_concept_relationship_id_1 ON omop.concept_relationship (concept_id_1 ASC);
...
CREATE CLUSTERED INDEX idx_relationship_rel_id ON omop.relationship (relationship_id ASC);

CREATE CLUSTERED INDEX idx_concept_synonym_id ON omop.concept_synonym (concept_id ASC);

CREATE CLUSTERED INDEX idx_concept_ancestor_id_1 ON omop.concept_ancestor (ancestor_concept_id ASC);
CREATE INDEX idx_concept_ancestor_id_2 ON omop.concept_ancestor (descendant_concept_id ASC);

CREATE CLUSTERED INDEX idx_source_to_concept_map_3 ON omop.source_to_concept_map (target_concept_id ASC);
...
CREATE CLUSTERED INDEX idx_drug_strength_id_1 ON omop.drug_strength (drug_concept_id ASC);
