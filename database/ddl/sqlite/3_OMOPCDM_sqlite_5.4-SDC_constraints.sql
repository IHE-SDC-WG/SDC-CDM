...
-- ALTER TABLE main.templateinstanceclass ADD CONSTRAINT fpk_templateinstanceclass_templatesdcfk FOREIGN KEY (templatesdcfk) REFERENCES main.templatesdcclass (pk);
-- ALTER TABLE main.templateinstanceclass ADD CONSTRAINT fpk_templateinstanceclass_personfk FOREIGN KEY (personfk) REFERENCES main.person (person_id);
-- ALTER TABLE main.templateinstanceclass ADD CONSTRAINT fpk_templateinstanceclass_encounterfk FOREIGN KEY (encounterfk) REFERENCES main.visit_occurrence (visit_occurrence_id);
-- ALTER TABLE main.templateinstanceclass ADD CONSTRAINT fpk_templateinstanceclass_practitionerfk FOREIGN KEY (practitionerfk) REFERENCES main.provider (provider_id);
-- ALTER TABLE main.sdcobsclass ADD CONSTRAINT fpk_sdcobsclass_templateinstanceclassfk FOREIGN KEY (templateinstanceclassfk) REFERENCES main.templateinstanceclass (pk);
-- ALTER TABLE main.sdcobsclass ADD CONSTRAINT fpk_sdcobsclass_parentfk FOREIGN KEY (parentfk) REFERENCES main.sdcobsclass (pk);
-- ALTER TABLE main.sdcobsclass ADD CONSTRAINT fpk_sdcobsclass_personfk FOREIGN KEY (personfk) REFERENCES main.person (person_id);
-- ALTER TABLE main.sdcobsclass ADD CONSTRAINT fpk_sdcobsclass_encounterfk FOREIGN KEY (encounterfk) REFERENCES main.visit_occurrence (visit_occurrence_id);
-- ALTER TABLE main.sdcobsclass ADD CONSTRAINT fpk_sdcobsclass_practitionerfk FOREIGN KEY (practitionerfk) REFERENCES main.provider (provider_id);
-- ALTER TABLE main.templatetermmapclass ADD CONSTRAINT fpk_templatetermmapclass_templatesdcfk FOREIGN KEY (templatesdcfk) REFERENCES main.templatesdcclass (pk);
-- ALTER TABLE main.templatemapcontentclass ADD CONSTRAINT fpk_templatemapcontentclass_templatetermmap_fk FOREIGN KEY (templatetermmap_fk) REFERENCES main.templatetermmapclass (pk);
-- ALTER TABLE main.specimenclass ADD CONSTRAINT fpk_specimenclass_parentspecimenfk FOREIGN KEY (parentspecimenfk) REFERENCES main.specimenclass (specimenpk);
-- ALTER TABLE main.observationspecimensclass ADD CONSTRAINT fpk_observationspecimensclass_sdcobsclassfk FOREIGN KEY (sdcobsclassfk) REFERENCES main.sdcobsclass (pk);
-- ALTER TABLE main.observationspecimensclass ADD CONSTRAINT fpk_observationspecimensclass_specimenfk FOREIGN KEY (specimenfk) REFERENCES main.specimenclass (specimenpk);
