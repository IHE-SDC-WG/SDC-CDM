...
--CREATE CLUSTERED INDEX idx_survey_person_id_1 ON main.survey_conduct (person_id ASC);
--CREATE CLUSTERED INDEX idx_episode_person_id_1 ON main.episode (person_id ASC);
--CREATE INDEX idx_episode_concept_id_1 ON main.episode (episode_concept_id ASC);
--CREATE CLUSTERED INDEX idx_episode_event_id_1 ON main.episode_event (episode_id ASC);
--CREATE INDEX idx_ee_field_concept_id_1 ON main.episode_event (event_field_concept_id ASC);
