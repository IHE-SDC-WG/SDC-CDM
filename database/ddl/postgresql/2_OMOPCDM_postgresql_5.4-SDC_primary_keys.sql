--postgresql CDM Primary Key Constraints for OMOP Common Data Model 5.4-SDC
...
ALTER TABLE public.templatesdcclass  ADD CONSTRAINT xpk_templatesdcclass PRIMARY KEY (pk);
ALTER TABLE public.templateinstanceclass  ADD CONSTRAINT xpk_templateinstanceclass PRIMARY KEY (pk);
ALTER TABLE public.sdcobsclass  ADD CONSTRAINT xpk_sdcobsclass PRIMARY KEY (pk);
ALTER TABLE public.templatetermmapclass  ADD CONSTRAINT xpk_templatetermmapclass PRIMARY KEY (pk);
ALTER TABLE public.templatemapcontentclass  ADD CONSTRAINT xpk_templatemapcontentclass PRIMARY KEY (pk);
ALTER TABLE public.templatesdcclass  ADD CONSTRAINT xpk_templatesdcclass PRIMARY KEY (pk);
ALTER TABLE public.templateinstanceclass  ADD CONSTRAINT xpk_templateinstanceclass PRIMARY KEY (pk);
ALTER TABLE public.sdcobsclass  ADD CONSTRAINT xpk_sdcobsclass PRIMARY KEY (pk);
ALTER TABLE public.templatetermmapclass  ADD CONSTRAINT xpk_templatetermmapclass PRIMARY KEY (pk);
...
ALTER TABLE public.templatetermmapclass  ADD CONSTRAINT xpk_templatetermmapclass PRIMARY KEY (pk);
ALTER TABLE public.templatemapcontentclass  ADD CONSTRAINT xpk_templatemapcontentclass PRIMARY KEY (pk);
ALTER TABLE public.specimenclass  ADD CONSTRAINT xpk_specimenclass PRIMARY KEY (specimenpk);
ALTER TABLE public.observationspecimensclass  ADD CONSTRAINT xpk_observationspecimensclass PRIMARY KEY (observationspecimensclasspk);
