	...
	<xsl:template match="/">
        ...
        <html>
			...
			<script type="text/javascript">
				...
				var classList = [];
				var options='<option value="-- Select Metadata Items --"> -- Select Metadata Items -- </option>';
				function toggle_dropdown()
				{
				$('.MetadataDisplay').children().each(function(e) {
				if (this.className != "" &amp;&amp; this.className != "nameDiv" &amp;&amp; this.className != "ChangeDisplay" &amp;&amp; classList.indexOf(this.className) == -1 &amp;&amp; this.className!="MetadataDisplay" ){
				options+= '<option value="'+this.className+'">'+this.className+'</option>'
				classList.push(this.className);
				}});
				if(classList!=null)
				{
				$("#MetaDataSelect").html(options);
				}
				var divsMD = document.getElementsByClassName('MetadataDisplay');
				var display = 'none';
				if (divsMD[0].style.display)
				{
				if (divsMD[0].style.display == 'none' )
				{$("#MetaDataSelect").show(); }
				else
				{$("#MetaDataSelect").hide(); }
				}
				...
				toggle_name();
				$('#MetaDataSelect').trigger('change'); //This event will fire the change event.
				...
				var data= $(this).val();
				var divsMD = document.getElementsByClassName($(this).val());
				//alert(divsMD);
				var display = 'none'
				if (divsMD[0].style.display)
				{
				...
				$(document).on("click", ".collapsable_q", function (e) {
					$(this).siblings().toggle();
					$(this).toggleClass("Question collapsed_q");
				});
			});
...
if(newtableitems[i].tagName=="input"){
	...
	try {
		...
		elements = newtable.getElementsByClassName('btnRemove');

		for(j=0;j<elements.length;j++)
		{

			if(elements[j].className=="btnRemove" && j==elements.length-1)
			{
			...
			<nav style="position: fixed; font-size:smaller;" id="navBar">
			 ...
			 <a href="##"  class="collapse_q_control">
				...
				<div class="BodyGroup">
					...
					<div id="FormData">
						<select id="MetaDataSelect" name="MetaDataSelect" >
						</select>
         ...
         <div class="MetadataDisplay">
			...
			<!-- GOT HERE R-2 -->
         	...
         	<xsl:if test="string(x:ResponseField/x:Response/x:string/@name) !='' ">
         		<!-- GOT HERE R-3 -->
				<div class="metadata_dt" >
					<div class="ResponseUnits">dt: </div><div class="metadataValue">string</div>
				</div>
         	...
         	<xsl:if test="string(x:ListItemResponseField/x:Response/x:decimal/@name) !='' ">
         		<!-- GOT HERE R-3 -->
				<div class="metadata_dt" >
					<div class="ResponseUnits">dt: </div><div class="metadataValue">decimal</div>
				</div>
         			<!--<div class="responseRequired">maxLength: </div> <xsl:value-of select="x:ListItemResponseField/x:Response/x:string/@maxLength"/> -->
         		<!-- <xsl:value-of select="x:ResponseField/x:Response/@val"/>-->
         	</xsl:if>	
         	...
         	<xsl:if test="string(x:ListItemResponseField/x:Response/x:int/@name) !='' ">
         		<!-- GOT HERE R-3 -->
				<div class="metadata_dt" >
					<div class="ResponseUnits">dt: </div><div class="metadataValue">int</div>
				</div>
         			<!--<div class="responseRequired">maxLength: </div> <xsl:value-of select="x:ListItemResponseField/x:Response/x:string/@maxLength"/> -->
         		<!-- <xsl:value-of select="x:ResponseField/x:Response/@val"/>-->
         	</xsl:if>	
         	<xsl:if test="string(x:ResponseField/x:Response/x:int/@name) !='' ">
         		<!-- GOT HERE R-3 -->
				<div class="metadata_dt" >
					<div class="ResponseUnits">dt: </div><div class="metadataValue">int</div>
				</div>
            ...
            <!-- </xsl:if> -->
         	...
         	<xsl:if test="string(x:Property/@val) != ''">  		
		        ...
		        <xsl:if test="string(x:Property/@propName) = 'altText'">
			      ...
			      <xsl:if test="string(x:ListItemResponseField/x:Response/x:decimal/@minInclusive ) !='' ">
					<div class="metadata_minInclusive" >
						<div class="minInclusive">minInclusive: </div>
						<xsl:value-of select="x:ListItemResponseField/x:Response/x:decimal/@minInclusive"/>
					</div>
				</xsl:if>
				<xsl:if test="string(x:ListItemResponseField/x:Response/x:int/@minInclusive ) !='' ">
					<div class="metadata_minInclusive" >
						<div class="minInclusive">minInclusive: </div>
						<xsl:value-of select="x:ListItemResponseField/x:Response/x:int/@minInclusive"/>
					</div>
				</xsl:if>
				<xsl:if test="string(x:ResponseField/x:Response/x:decimal/@minInclusive ) !='' ">
					<div class="metadata_minInclusive" >
						<div class="minInclusive">minInclusive: </div>
						<xsl:value-of select="x:ResponseField/x:Response/x:decimal/@minInclusive"/>
					</div>
				</xsl:if>
				<xsl:if test="string(x:ResponseField/x:Response/x:int/@minInclusive ) !='' ">
					<div class="metadata_minInclusive" >
						<div class="minInclusive">minInclusive: </div>
						<xsl:value-of select="x:ResponseField/x:Response/x:int/@minInclusive"/>
					</div>
				</xsl:if>
				<xsl:if test="string(x:ListItemResponseField/x:Response/x:decimal/@maxInclusive ) !=''">
					<div class="metadata_maxInclusive" >
						<div class="maxInclusive">maxInclusive: </div>
						<xsl:value-of select="x:ListItemResponseField/x:Response/x:decimal/@maxInclusive"/>
					</div>
				</xsl:if>
				<xsl:if test="string(x:ListItemResponseField/x:Response/x:int/@maxInclusive ) !='' ">
					<div class="metadata_maxInclusive" >
						<div class="maxInclusive">maxInclusive: </div>
						<xsl:value-of select="x:ListItemResponseField/x:Response/x:int/@maxInclusive"/>
					</div>
				</xsl:if>
				<xsl:if test="string(x:ResponseField/x:Response/x:decimal/@maxInclusive ) !=''">
					<div class="metadata_maxInclusive" >
						<div class="maxInclusive">maxInclusive: </div>
						<xsl:value-of select="x:ResponseField/x:Response/x:decimal/@maxInclusive"/>
					</div>
				</xsl:if>
				<xsl:if test="string(x:ResponseField/x:Response/x:int/@maxInclusive ) !='' ">
					<div class="metadata_maxInclusive" >
						<div class="maxInclusive">maxInclusive: </div>
						<xsl:value-of select="x:ResponseField/x:Response/x:int/@maxInclusive"/>
					</div>
				</xsl:if>
				<xsl:if test="string(x:ListItemResponseField/x:Response/x:decimal/@totalDigits ) !='' ">
					<div class="metadata_maxChar" >
						<div class="totalDigits">maxChar: </div>
						<xsl:value-of select="x:ListItemResponseField/x:Response/x:decimal/@totalDigits"/>
					</div>
				</xsl:if>
				<xsl:if test="string(x:ResponseField/x:Response/x:decimal/@totalDigits ) !='' ">
					<div class="metadata_maxChar" >
						<div class="totalDigits">maxChar: </div>
						<xsl:value-of select="x:ResponseField/x:Response/x:decimal/@totalDigits"/>
					</div>
				</xsl:if>
				<xsl:if test="string(x:ListItemResponseField/x:Response/x:decimal/@fractionDigits ) !='' ">
					<div class="metadata_maxDecimals" >
						<div class="maxDecimals">maxDecimals: </div>
						<xsl:value-of select="x:ListItemResponseField/x:Response/x:decimal/@fractionDigits"/>
					</div>
				</xsl:if>
				<xsl:if test="string(x:ResponseField/x:Response/x:decimal/@fractionDigits ) !='' ">
					<div class="metadata_maxDecimals" >
						<div class="maxDecimals">maxDecimals: </div>
						<xsl:value-of select="x:ResponseField/x:Response/x:decimal/@fractionDigits"/>
					</div>
				</xsl:if>
				 <xsl:if test="string(x:ListItemResponseField/x:Response/x:string/@maxLength ) !='' ">
						<div class="metadata_maxLength" >
							<div class="maxLength">maxLength: </div>
							<xsl:value-of select="x:ListItemResponseField/x:Response/x:string/@maxLength"/>
						</div>
					</xsl:if>
					<xsl:if test="string(x:ResponseField/x:Response/x:string/@maxLength ) !='' ">
						<div class="metadata_maxLength" >
							<div class="maxLength">maxLength: </div>
							<xsl:value-of select="x:ResponseField/x:Response/x:string/@maxLength"/>
						</div>
					</xsl:if>	 
		...
		<xsl:if test="$metadata-display = 'true'">
			<div class="{string($metadataClass)}" style="display:inline">
				...
				<xsl:if test="string(x:Property/@val) != ''">
					...
					<xsl:if test="string(x:Property/@propName) = 'reportText'">
						<div class="metadata_rptText" style="display:inline">
							<div class="reportText">
								rptText:
							</div>
						</div>
				...
				<xsl:if test="string(@name) != ''">
						<div class="nameDiv">
							<div class="name">name: </div>
							<div class="nameValue" style="color:white">
								<xsl:value-of select="@name"/>
							</div>
						</div>
				</xsl:if>
   ...
   <xsl:template name="ItemWithID">
      <xsl:param name="required"/>
       <xsl:if test="$required = 'false' or @mustImplement = 'false'">	  
         <div class="metadata_notRequired">+</div>
      </xsl:if>		 
